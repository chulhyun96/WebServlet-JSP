...
<div class="bg-white p-8 rounded-lg shadow-lg">
    <h1 class="block text-sm font-medium text-black-700">로그인을 먼저 해주세요.</h1>
    <form method="get" action="/member/login" class="flex flex-col space-y-4">
        <div>
            <label for="userID" class="block text-sm font-medium text-red-700">UserID</label>
        ...
        <div>
            <label for="userPassword" class="block text-sm font-medium text-red-700">PW</label>
    ...
    <div class="flex justify-between mt-6">
        ...
        <a href="list" class="italic antialiased font-serif bg-black text-white mt-3 px-8 py-2 rounded-md
